...
QT_MOC_LITERAL(1, 14, 12), // "on_readyRead"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 15), // "on_disconnected"
QT_MOC_LITERAL(4, 44, 15) // "on_send_request"

    },
    "SocketAdapter\0on_readyRead\0\0on_disconnected\0"
    "on_send_request"
};
...
QT_INIT_METAOBJECT const QMetaObject SocketAdapter::staticMetaObject = { {
    &ISocketAdapter::staticMetaObject,
...
void *SocketAdapter::qt_metacast(const char *_clname)
{
    ...
    return ISocketAdapter::qt_metacast(_clname);
}

int SocketAdapter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ISocketAdapter::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
